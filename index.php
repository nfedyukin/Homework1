...
?></b>
<br>
3.2. В выражении <b>$x = ($y = 12) - 8; echo $x;</b> кроме выполнения арифметических операций происходит присвоение
значения пересенной <b>$y</b>, и оператор присвоения возвращает присвоенное значание для дальнейшего вычисления.
Результат:<b>
<?php
$x = ($y = 12) - 8; echo $x;
?></b>
